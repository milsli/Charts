...
struct PressureElement
{
    ...
    uint16_t pressureDiff_;     // zmiana ciśnienia w zadanym interwale czasowym, dla skokowego  (todo: wyjaśnić czy dla jednego schodka czy dla interwału) a min ciśnienie dla sinusa
